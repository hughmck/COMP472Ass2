    ...
    def get_moves(self, filled_board=None):
        ...
        if filled_board is None:
                    ...
                    for coord in car.occupy_square:
                        if car.vert:
                            if (coord[0] + 1) < 6 and board[coord[0] + 1][coord[1]] == ".":  # square below
                                ...
                                print(
                                    "The car " + car.name + " can not move downwards from square " + str(
                                        coord[0]) + "," + str(
                                        coord[1]) + " to " + str(coord[0] + 1) + "," + str(coord[1]) + "because something is there")
                            ...
                            if (coord[1] + 1) < 6 and board[coord[0]][coord[1] + 1] == ".":  # square to the right
                                ...
                                print("The car " + car.name + " can not move to the right from square " + str(
                                    coord[0]) + "," + str(coord[1]) + " to " + str(coord[0]) + "," + str(coord[1] + 1)+ "because something is there")
            ...
            for i in range(5):
                for j in range(5):
                    if board[i][j] != ".":
                        if (i + 1 < 6 and board[i][j] == board[i + 1][j]) or (
                                i - 1 >= 0 and board[i][j] == board[i - 1][j]):  # check if piece below is the same letter, if true piece is vertical
